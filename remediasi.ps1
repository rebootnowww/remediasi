...
Write-Host "Ensure 'Enforce password history' is set to '24 or more password(s)'."
    net accounts /uniquepw:24
start-sleep -Seconds 1 

#Ensure 'Minimum password age' is set to '1 or more day(s)'.
Write-Host "Ensure 'Minimum password age' is set to '1 or more day(s)'."
    net accounts /minpwage:1
start-sleep -Seconds 1 

#Ensure 'Minimum password length' is set to '14 or more character(s)'.
Write-Host "Ensure 'Minimum password length' is set to '14 or more character(s)'."
...
Write-Host "Ensure 'Account lockout threshold' is set to '5 or fewer invalid logon attempt(s), but not 0'."
...
Write-Host "Ensure 'Interactive logon: Don't display last signed-in' is set to 'Enabled'."
# Define the registry path and value
$registryPath = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System"
...
Write-Host "Ensure 'Audit Credential Validation' is set to 'Success and Failure'."
    auditpol /set /subcategory:"Credential Validation" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit Kerberos Authentication Service' is set to 'Success and Failure' (DC Only).
Write-Host "Ensure 'Audit Kerberos Authentication Service' is set to 'Success and Failure' (DC Only)."
    auditpol /set /subcategory:"Kerberos Authentication Service" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit Kerberos Service Ticket Operations' is set to 'Success and Failure' (DC Only).
Write-Host "Ensure 'Audit Kerberos Service Ticket Operations' is set to 'Success and Failure' (DC Only)."
    auditpol /set /subcategory:"Kerberos Service Ticket Operations" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit Application Group Management' is set to 'Success and Failure'.
Write-Host "Ensure 'Audit Application Group Management' is set to 'Success and Failure'."
    auditpol /set /subcategory:"Application Group Management" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit Distribution Group Management' is set to include 'Success' (DC only).
Write-Host "Ensure 'Audit Distribution Group Management' is set to include 'Success' (DC only)."
...
Write-Host "Ensure 'Audit Other Account Management Events' is set to include 'Success' (DC only)."
...
Write-Host "Ensure 'Audit User Account Management' is set to 'Success and Failure'."
    auditpol /set /subcategory:"User Account Management" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit PNP Activity' is set to include 'Success'.
Write-Host "Ensure 'Audit PNP Activity' is set to include 'Success'."
    auditpol /set /subcategory:"Plug and Play Events" /success:enable
start-sleep -Seconds 1

#Ensure 'Audit Process Creation' is set to include 'Success'.
Write-Host "Ensure 'Audit Process Creation' is set to include 'Success'."
    auditpol /set /subcategory:"Process Creation" /success:enable
start-sleep -Seconds 1

#Ensure 'Audit Directory Service Access' is set to include 'Failure' (DC only).
Write-Host "Ensure 'Audit Directory Service Access' is set to include 'Failure' (DC only)."
...
Write-Host "Ensure 'Audit Directory Service Changes' is set to include 'Success' (DC only)."
    auditpol /set /subcategory:"Directory Service Changes" /success:enable
start-sleep -Seconds 1

#Ensure 'Audit Account Lockout' is set to include 'Failure'.
Write-Host "Ensure 'Audit Account Lockout' is set to include 'Failure'."
    auditpol /set /subcategory:"Account Lockout" /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit Group Membership' is set to include 'Success'.
Write-Host "Ensure 'Audit Group Membership' is set to include 'Success'."
...
Write-Host "Ensure 'Audit Other Logon/Logoff Events' is set to 'Success and Failure'."
    auditpol /set /subcategory:"Other Logon/Logoff Events" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit Detailed File Share' is set to include 'Failure'.
Write-Host "Ensure 'Audit Detailed File Share' is set to include 'Failure'."
    auditpol /set /subcategory:"Detailed File Share" /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit File Share' is set to 'Success and Failure'.
Write-Host "Ensure 'Audit File Share' is set to 'Success and Failure'."
    auditpol /set /subcategory:"File Share" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit Other Object Access Events' is set to 'Success and Failure'.
Write-Host "Ensure 'Audit Other Object Access Events' is set to 'Success and Failure'."
    auditpol /set /subcategory:"Other Object Access Events" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit Removable Storage' is set to 'Success and Failure'.
Write-Host "Ensure 'Audit Removable Storage' is set to 'Success and Failure'."
    auditpol /set /subcategory:"Removable Storage" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit Authorization Policy Change' is set to include 'Success'.
Write-Host "Ensure 'Audit Authorization Policy Change' is set to include 'Success'."
    auditpol /set /subcategory:"Authorization Policy Change" /success:enable
start-sleep -Seconds 1

#Ensure 'Audit MPSSVC Rule-Level Policy Change' is set to 'Success and Failure'.
Write-Host "Ensure 'Audit MPSSVC Rule-Level Policy Change' is set to 'Success and Failure'."
    auditpol /set /subcategory:"MPSSVC Rule-Level Policy Change" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit Other Policy Change Events' is set to include 'Failure'.
Write-Host "Ensure 'Audit Other Policy Change Events' is set to include 'Failure'."
...
Write-Host "Ensure 'Audit Sensitive Privilege Use' is set to 'Success and Failure'."
    auditpol /set /subcategory:"Sensitive Privilege Use" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit IPsec Driver' is set to 'Success and Failure'.
Write-Host "Ensure 'Audit IPsec Driver' is set to 'Success and Failure'."
    auditpol /set /subcategory:"IPsec Driver" /success:enable /failure:enable
start-sleep -Seconds 1

#Ensure 'Audit Security System Extension' is set to include 'Success'.
Write-Host "Ensure 'Audit Security System Extension' is set to include 'Success'."
...
Write-Host "Ensure 'Configure RPC packet level privacy setting for incoming connections' is set to 'Enabled'."
    ...
    $registryName = "RpcAuthnLevelPrivacyEnabled"
    $registryValue = 1
...
Write-Host "Ensure 'Configure RPC connection settings: Protocol to use for outgoing RPC connections' is set to 'Enabled: RPC over TCP'."
    # Define the registry path and value
    $registryPath = "HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers"
    $registryName = "RpcUseNamedPipeProtocol"
    $registryValue = 1
    # Function to create the registry key if it does not exist
    function New-RegistryKey {
        param (
